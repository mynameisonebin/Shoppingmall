						...
						<div class="card-body">
							<c:forEach var="itemDetail" items="${itemDetail}">
								<table class="table table-striped">
									<tr>     
										<td align="center" rowspan="7"  ><img src="<c:url value="/image/${itemDetail.itemThumbImage }"/>" width="200px" height="250px" alt="no"></td>
									</tr>
									<tr>
										<th>상품 코드</th>
									...
									<tr>  
										<td align="center" colspan="3">${itemDetail.itemDesc}</td>
									</tr>
								</table>
								<form action="/web/admin/itemDelete" method="post" style="text-align: center;" class="form">
									...
									<input type="hidden" name="itemCode" value="${itemDetail.itemCode}">
									<input type="hidden" name="itemSize" value="${itemDetail.itemSize}">
									<input type="button" onclick="window:location='/web/admin/itemUpdateForm/${itemDetail.itemCode}&${itemDetail.itemSize}'" value="상품 수정">
